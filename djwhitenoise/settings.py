"""
Django settings for djwhitenoise project.
...
SECRET_KEY = 'django-insecure-=acah^%972m#*s)ze-ht2+$b*xth_w))^ky-=8%&_*zbzc1us8'
...
ROOT_URLCONF = 'djwhitenoise.urls'
...
WSGI_APPLICATION = 'djwhitenoise.wsgi.application'
